...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Daashboard" subTitle="Monitor overall platform performance including total cars,bookings,revenue,and recent activites" />
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
        ...
        {/* monthly revenue */}
        <div className='p-4 md:p-6 border border-gray-300 rounded-md md:max-w-xs w-full' >
